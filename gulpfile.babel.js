...
gulp.task('scripts', () =>
  gulp.src([
      ...
      './app/scripts/angular-inview.min.js',
      './app/scripts/angular-scroll.min.js',
      './app/scripts/angular-animate.min.js',
      './app/scripts/angular-ui-router.min.js',
      './app/scripts/app.js',
      './app/scripts/controllers.js',
      './app/scripts/directives.js',
      './app/scripts/paper-core.min.js',
      './app/scripts/simplex-noise.js',
...
gulp.task('pagespeed', cb =>
  ...
  pagespeed('http://portfolio.nbcuxlab.com', {
    strategy: 'mobile'
